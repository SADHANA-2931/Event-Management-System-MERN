...
export default function IndexPage() {
  ...
  // ✅ Track liked events using localStorage
  ...
  const handleLike = (eventId) => {
    if (likedEvents.includes(eventId)) {
      alert("You already liked this event.");
      return;
    }
    ...
    axios
      ...
      .then((response) => {
        ...
        const updatedLiked = [...likedEvents, eventId];
        setLikedEvents(updatedLiked);
              ...
              return (
                <div className="bg-white rounded-xl relative" key={event._id}>
                  <div className="rounded-tl-[0.75rem] rounded-tr-[0.75rem] object-fill aspect-16:9">
                    ...
                    <div className="absolute flex gap-4 bottom-[240px] right-8 md:bottom-[20px] md:right-3 lg:bottom-[250px] lg:right-4 sm:bottom-[260px] sm:right-3">
                      <button
                        ...
                        disabled={likedEvents.includes(event._id)}
                        title={
                  ...
                  <img
                    ...
                    alt=""
                    className="rounded-tl-[0.75rem] rounded-tr-[0.75rem] object-fill aspect-16:9"
                  />
